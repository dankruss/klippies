...
<html>
	...
	<body>
		<a href="#edit-mobiUser" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-mobiUser" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${mobiUserInstance?.version}" />
				<fieldset class="form">
